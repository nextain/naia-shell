...
readonly EXPECTED_IMAGE_TAG="candidate-bc250-0.2.3-13980895-support8"
...
install -Dm0644 "$IMAGE_LAYER_DIR/config/scripts/install-naia-toolchain.sh" \
  "$context_dir/defaults/install-naia-toolchain.sh"
