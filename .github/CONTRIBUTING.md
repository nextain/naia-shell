...
| 버그 리포트 | 낮음 | [GitHub Issues](https://github.com/nextain/new-naia-os/issues) 에 재현 절차와 함께 등록 |
| 문서 개선 | 낮음 | [`docs/`](../docs/), [`.users/`](../.users/) |
| 사용 후기·테스트 | 낮음 | 앱을 써 보고 [Issues](https://github.com/nextain/new-naia-os/issues) 또는 [Discord](https://discord.gg/FGYJN7auty)에 피드백·로그 공유 |
...
> 문서·번역·작은 코드 수정만 할 거라면 이 장은 건너뛰어도 됩니다. **앱을 직접 띄워 확인하려는 분만** 보세요.

Naia OS는 [Tauri](https://tauri.app/)로 만든 데스크톱 앱이라, 빌드하려면 **Node.js + Rust + 각 OS의 시스템 라이브러리**가 필요합니다. (Linux에서 가장 많이 검증됐지만 Windows·macOS도 동작합니다.)
...
| 단계 | 할 일 | 산출물 |
|---|---|---|
| 0 | 작업할 이슈를 고르거나 새로 등록 | [GitHub Issue](https://github.com/nextain/new-naia-os/issues) |
...
아직 이 주제들에 대한 별도 가이드 문서는 없습니다. 작업을 시작하려면 [GitHub Issues](https://github.com/nextain/new-naia-os/issues)에 제안 이슈를 먼저 열거나 [Discord](https://discord.gg/FGYJN7auty)에서 문의해 주세요.
