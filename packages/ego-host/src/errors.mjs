...
export const CODES = Object.freeze({
  ...
  // S6c — 관리 연결(소유자 전용 통로)
  ADMIN_REQUIRED: "EGO_HOST_ADMIN_REQUIRED",
  ADMIN_DENIED: "EGO_HOST_ADMIN_DENIED",
  ADMIN_UNAVAILABLE: "EGO_HOST_ADMIN_UNAVAILABLE",
  ...
  // S2b — 런처·lease·조정
  BROWSER_NOT_FOUND: "EGO_HOST_BROWSER_NOT_FOUND",
  BROWSER_LAUNCH_FAILED: "EGO_HOST_BROWSER_LAUNCH_FAILED",
  BROWSER_GONE: "EGO_HOST_BROWSER_GONE",
  LEASE_INVALID: "EGO_HOST_LEASE_INVALID",
  USAGE: "EGO_HOST_USAGE",
  // S2e — 작업 장부·취소 훅·deadline (계약 4.4·4.7)
  OPERATION_TIMEOUT: "EGO_OPERATION_TIMEOUT",
  OPERATION_CANCELLED: "EGO_OPERATION_CANCELLED",
  OPERATION_NOT_FOUND: "EGO_OPERATION_NOT_FOUND",
  RESOURCE_NOT_OWNED: "EGO_RESOURCE_NOT_OWNED",
  SESSION_SLOT_BUSY: "EGO_SESSION_SLOT_BUSY",
  DOMAIN_IN_USE: "EGO_DOMAIN_IN_USE",
  EVIDENCE_FAILED: "EGO_HOST_EVIDENCE_FAILED",
});
