...
| file-anchor-guard | `.agents/hooks/file-anchor-guard.js` | file-anchor-guard — PreToolUse on Write\|Edit. 파일단위 계약 앵커 강제(라이브). |
| mirror-sync | `.agents/hooks/mirror-sync.js` | mirror-sync — PostToolUse on Edit\|Write. |
