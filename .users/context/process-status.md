...
- 상태: P01~P03 완료, P04는 승인된 `NAIA_API_KEY` 실행 환경 변수가 없어 차단, P05 대기. 2026-09-14T06:20:27Z 재확인에서 assembly coverage 69/20, 측정 하네스 12/12, syntax/dry-run, workspace tsc, `git diff --check`가 통과했다. 구조 검사는 기존 `tmp/`·`.local/`·`tsconfig.build.json`을 보고했다. 라이브 러너는 키 부재로 Agent 시작과 게이트웨이 요청 전에 fail-closed 했다. 인접 Agent checkout도 pinned·clean 상태가 아니다. 차단 영수증: `docs/regression-runs/naia3090-2026-09-14T06-20-27Z-592-tool-calling-blocked.json`.
