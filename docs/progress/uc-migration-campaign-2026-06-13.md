...
| S-row(잔여) | voicewake(deprecated)·sessions/panel/device/config(os-side?)·channels/naia-discord(gateway)·skill-manager·welcome | placement 분석 필요 | ✗ | ✗ | — | **⚠️ blind 이식 금지 — os/agent/deprecated placement 결정 필요** |
