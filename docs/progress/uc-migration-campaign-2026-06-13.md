...
| V2 | 음성(UC2) | **계약 drafted(V2-baseline-contract)** | os-local 이식 next | 계약 리뷰 next | 루크머신 voice baseline | **계약+분해 완료, os-local 이식 진행중** |
