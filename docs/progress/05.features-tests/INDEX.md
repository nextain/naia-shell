...
| TEST-F-012 | SPEC-012 | Codex provider option·role config roundtrip·keyless chat service와 stage-agent/stage-runtime/tauri/build.rs의 동일 Agent commit 및 proto SHA 고정을 검증 | `packages/shell/src/components/__tests__/SettingsTab.test.tsx`, `packages/shell/src/lib/__tests__/adk-store.test.ts`, `chat-service.test.ts`, `src/test/uc-wire-v1-paired-proto.contract.test.ts` | Pass |
