...
| `AppPort`(facade: Chat·Tool·Approval·Panel sub-port) | bi | ports | semantic 명령/이벤트, 다중 구독 | 1단계 골격 |
...
| `ClientSessionPort`(multi-client) | — | **control-plane** | client 신원·capability negotiation·subscription lifecycle | 2~4단계 |
